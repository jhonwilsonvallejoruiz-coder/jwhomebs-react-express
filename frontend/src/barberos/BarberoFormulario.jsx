// Componente formulario para registrar un nuevo barbero con validaciones
import { useState } from 'react';
import { crearBarbero } from '../services/barberoService';

const BarberoFormulario = ({ onVolver }) => {
    ...
    const validarFormulario = () => {
        ...
        if (!formulario.nombreBarbero.trim()) {
            ...
            nuevosErrores.nombreBarbero = 'El nombre solo debe contener letras y espacios (mínimo 3, máximo 50 caracteres).';
        }
        ...
        // Validación de la especialidad: obligatoria
    ...
    const handleSubmit = async (e) => {
        ...
        await crearBarbero(formulario);
        onVolver();
    };

    return (
        <div style={estilos.contenedor}>
            <h2 style={estilos.titulo}>Registrar Nuevo Barbero</h2>
            <form onSubmit={handleSubmit} style={estilos.form}>
                ...
                <input
                    ...
                    placeholder="Ej: Corte clásico, Barba, Diseño"
